...
export const stages = {
  ...
  service: { label: '服务执行', owner: 'service', tone: 'orange' },
  followup: { label: '顾客回访', owner: 'aftercare', tone: 'green' },
...
function seedData() {
  const employees = [
    { id: 'E001', name: '陈场控', role: '场控', roleKey: 'floorControl', store: '科臻澳总店' },
    { id: 'E002', name: '李医生', role: '医生', roleKey: 'doctor', store: '科臻澳总店' },
    { id: 'E003', name: '王护理', role: '服务顾问', roleKey: 'service', store: '科臻澳总店' },
    { id: 'E004', name: '赵回访', role: '回访专员', roleKey: 'aftercare', store: '科臻澳总店' }
  ]
  const customers = [
    { id: 'C001', name: '林女士', gender: '女', birthday: '1993-06-18', phone: '13800138001', store: '科臻澳总店', memberLevel: '金卡', source: '线上咨询', preferences: '偏好下午到店，关注抗衰项目', taboos: '青霉素过敏史待确认', preparation: '已完成初次需求沟通', note: '需关注术后恢复感受', owners: { floorControl: '陈场控', doctor: '李医生', service: '王护理', aftercare: '赵回访' }, balance: 6800, points: 1260, packages: [{ project: '光子嫩肤', purchased: 5, used: 2, expiry: '2027-06-30' }], images: [{ type: '术前', project: '光子嫩肤', date: '2026-07-20' }], followups: [] },
    { id: 'C002', name: '周女士', gender: '女', birthday: '1989-11-02', phone: '13800138002', store: '科臻澳总店', memberLevel: '普通会员', source: '老客转介绍', preferences: '偏好微信沟通', taboos: '暂无记录', preparation: '医生初步评估已完成', note: '', owners: { floorControl: '陈场控', doctor: '李医生', service: '王护理', aftercare: '赵回访' }, balance: 0, points: 480, packages: [{ project: '面部抗衰', purchased: 3, used: 1, expiry: '2026-12-31' }], images: [], followups: [] },
    { id: 'C003', name: '孙女士', gender: '女', birthday: '1996-03-09', phone: '13800138003', store: '科臻澳总店', memberLevel: '铂金', source: '到店咨询', preferences: '重视隐私和恢复周期', taboos: '暂无记录', preparation: '等待服务后回访', note: '优先确认满意度', owners: { floorControl: '陈场控', doctor: '李医生', service: '王护理', aftercare: '赵回访' }, balance: 12000, points: 2100, packages: [{ project: '轮廓提升', purchased: 2, used: 1, expiry: '2027-01-01' }], images: [{ type: '术后', project: '轮廓提升', date: '2026-07-24' }], followups: [] }
  ]
  const assignments = { floorControl: '陈场控', doctor: '李医生', service: '王护理', aftercare: '赵回访' }
  const records = [
    ...
    { id: 'B20260727002', customerId: 'C002', vip1: { name: '周女士', phone: '13800138002' }, vip2: null, businessDate: date(), appointmentTime: '13:30', diagnosisType: '复诊', estimatedProject: '面部抗衰', projects: ['面部抗衰'], department: '抗衰中心', store: '科臻澳总店', status: 'doctorDiagnosis', assignments, flags: ['顾客已到店'], floorControl: { scheduledTime: `${date()} 12:50`, managerSuggestion: '面部抗衰', note: '复诊评估' }, doctorDiagnosis: {}, serviceExecution: {}, followupRecords: [], logs: [log('陈场控', '完成场控排诊', '顾客已到店，转医生排诊', 'floorControl', 'doctorDiagnosis')] },
    { id: 'B20260726003', customerId: 'C003', vip1: { name: '孙女士', phone: '13800138003' }, vip2: null, businessDate: '2026-07-26', appointmentTime: '15:00', diagnosisType: '新诊', estimatedProject: '轮廓提升', projects: ['轮廓提升'], department: '微整注射科', store: '科臻澳总店', status: 'followup', assignments, flags: ['回访已到期'], floorControl: {}, doctorDiagnosis: { doctor: '李医生', nurse: '王护理', note: '项目执行安排完成' }, serviceExecution: { result: '服务已结束', projects: ['轮廓提升'], note: '服务顺利完成', followupDate: date() }, followupRecords: [], logs: [log('王护理', '完成服务执行', '已生成顾客回访任务', 'service', 'followup')] },
    { id: 'B20260725004', customerId: 'C001', vip1: { name: '林女士', phone: '13800138001' }, vip2: null, businessDate: '2026-07-25', appointmentTime: '11:00', diagnosisType: '复诊', estimatedProject: '补水保湿', projects: ['补水保湿'], department: '皮肤管理科', store: '科臻澳总店', status: 'cancelled', assignments, flags: ['已取消：顾客临时有事'], floorControl: {}, doctorDiagnosis: {}, serviceExecution: {}, followupRecords: [], logs: [log('陈场控', '取消业务', '顾客临时有事', 'arrivalConfirmation', 'cancelled', 'danger')] }
  ]
...
export function getData() { ensureDemoData(); return clone(uni.getStorageSync(DATA_KEY)) }
